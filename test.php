...
<div class="content" style="font-family:snap ITC;">
    ...
    <div id="left menu" width="50%" style="float:left;">
    <h1> Test Page </h1>
    <br>
  	<div style="font-family:Verdana, Geneva, sans-serif; font-size:20px;">
        <strong><a href="test1.php">Test101 </a></strong><br><br>
        <strong><a href="test2.php">Test102 </a></strong><br><br>
        <strong><a href="test3.php">Test103 </a></strong><br><br>
        <strong><a href="test4.php">Test104 </a></strong><br><br>
        <strong><a href="test5.php">Test105 </a></strong><br><br>
        <strong><a href="test6.php">Test106 </a></strong><br><br>
        <strong><a href="test7.php">Test107 </a></strong><br><br>
        <strong><a href="test8.php">Test108 </a></strong><br><br>
        <strong><a href="test9.php">Test109 </a></strong><br><br>
        <strong><a href="test10.php">Test110 </a></strong><br>
    ...
    <div align="center">
    	<img src="images/test.jpg" width="400px">
    </div>
