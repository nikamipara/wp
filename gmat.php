...
<div class="content" style="font-family:snap ITC;">
    ...
    <div id="left menu">
    <h1> Graduate Management Admission Test </h1>
    <br>
  	<div style="font-family:Verdana, Geneva, sans-serif; font-size:20px;">
        <strong>What is GMAT? </strong>
        <p> The Graduate Management Admission Test (GMAT) is a computer adaptive test which assesses a person's analytical, writing, quantitative, verbal and reading skills in standard written English in preparation for being admitted into a graduate management program, such as an MBA. More than 5,400 programs offered by more than 1,500 universities and institutions in 83 countries use the GMAT exam as part of the selection criteria for their programs site. </p><br>
        
        <strong>Why Vocabulary is important for GMAT? </strong><br> The GMAT doesn't directly test vocabulary - but having a powerful vocabulary will help you score higher on two of the three major sections of the test. For example:<br>

The Verbal Section: There are three types of questions in the verbal section: Reading Comprehension, Critical Reasoning, and Sentence Correction<br>

Reading Comprehension is really vocabulary comprehension. Over 100 years of research has proven that the more words you know, the faster you read and the more you comprehend.
    </div>
  	</div>
