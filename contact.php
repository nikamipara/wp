...
<div class="content" style="font-family:snap ITC;">
    ...
    <br>
  	<div style="font-family:Verdana, Geneva, sans-serif; font-size:20px;">
        <p> Use the information below to send us your comments or report any problems you experienced finding information on our website. We read all feedback carefully, we will respond to the comments you submit as soon as possible. </p><br>
        
        <strong>E-mail: </strong> feedback.vocab@gmail.com
        <br>
        <strong>Facebook page: </strong> https://facebook.com/daiict.vocab
        <br>
