...
<div class="content" style="font-family:snap ITC;">
	<div id="menu" align="right"style="display:block;background-image:url(images/blackbg.png); margin-left:auto; font-family:snap ITC; color:white; height:35px;">
    ...
    <br>
  	<div style="font-family:Verdana, Geneva, sans-serif; font-size:20px;">
        <strong> Update top 100 </strong><br>
        <form>
        Replace <select></select> by <select></select>
        <input type="submit">
        </form>
        
        <br>
        <strong> Add word </strong><br>
        
        <form>
        <input type="text" placeholder="Word" name='word'><br>
        <input type="text" placeholder="Meaning" name="meaning"><br>
        <input type="text" placeholder="Example" name="example"><br>
        <input type="submit">
        </form>
