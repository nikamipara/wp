...
<div class="content">
	...
	display: inline; font-size:24px;"><a href="contact.php" style="text-decoration:none;">Contact us</a></li>
            <li style="list-style: none;
	padding: 50px;	
	display: inline; font-size:24px;"><a href="logout.php?PHPSESSID='<?php echo $SID ?>' style="text-decoration:none;">Log Out</a></li>
        </ul>
    </div>
          <ul class="ca-menu">
                    <li>
                    ...
                    <li>
                     ...
                     <li>
                        <a href="profile.php?PHPSESSID='<?php echo $SID?>'">
...
<a href="vocab.php"><img src="images/vocab.jpg" alt="Todo el Todo" width="413" height="220" /><span class="desc">
    ...
    <main>    
      ...
      <fcapion>
     <h1>GRE </h1>
      </fcaption><a href="gre.php"><img src="images/gre.jpg" alt="GRE" width="289" height="175" /></a></figure>
      </div>
    <div class="abox">
      <figure>
      <fcapion>
    ...
    <div class="abox">
      ...
      <fcapion>
     <h1>CAT</h1>
      </fcaption><a href="cat.php"><img src="images/cat.jpg" alt="CAT" width="289" height="178" /></a></figure>
      </div>   
    </main>
    <!--end main -->
    <footer>  
